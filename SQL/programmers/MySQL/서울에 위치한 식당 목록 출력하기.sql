...
SELECT RI.REST_ID, RI.REST_NAME, FOOD_TYPE, FAVORITES, ADDRESS, ROUND(AVG(REVIEW_SCORE), 2) AS AVG_SCORE
FROM REST_INFO RI JOIN REST_REVIEW RR ON RI.REST_ID = RR.REST_ID
WHERE ADDRESS LIKE '%서울%'
GROUP BY RI.REST_ID, RI.REST_NAME, FOOD_TYPE, FAVORITES, ADDRESS
